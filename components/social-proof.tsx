...
import { Star, Quote, TrendingDown, Clock, Shield, Zap } from "lucide-react";
  ...
  const testimonios = [
  {
    ...
    texto: "Antes tardábamos 3 días en leer todos los medidores. Ahora los datos llegan solos y la facturación es automática. Le ahorramos al condominio más de $200.000 mensuales en gestión.",
    estrellas: 5,
    avatar: "CM",
  ...
  },
  {
    ...
    empresa: "Empresa distribuidora, R.M.",
    texto: "La detección de anomalías nos ayudó a identificar 12 conexiones ilegales en el primer mes. El sistema se pagó solo en menos de 60 días.",
    estrellas: 5,
    avatar: "PR",
  ...
  },
  {
    ...
    texto: "Tengo 8 locales comerciales y ahora puedo ver el consumo de cada uno desde el celular. Si alguno se pasa del límite, me llega una alerta al instante.",
    estrellas: 5,
    avatar: "RF",
