...
export function CotizacionesDashboard({
  ...
  useEffect(() => {
    cargarCotizaciones();
  }, [filtros, paginaActual, cargarCotizaciones]);
  ...
  const actualizarCotizacion = async (
    ...
    try {
      ...
      setErrorMsg(
        "Ocurrió un error al actualizar la cotización. Por favor, intente nuevamente."
      );
    } finally {
      setIsUpdating(false);
    }
  ...
  const eliminarCotizacion = async () => {
    ...
    try {
      ...
      if (
        cotizacionSeleccionada &&
        cotizacionSeleccionada._id === cotizacionAEliminar
      ) {
        setMostrarDetalles(false);
      ...
      setErrorMsg(
        "Ocurrió un error al eliminar la cotización. Por favor, intente nuevamente."
      );
            ...
            <div>
              ...
              <div className="mt-2 space-y-2">
                <p>
                  ...
                  {formatServicio(cotizacionSeleccionada.servicio)}
                </p>
                ...
                <p>
                  ...
                  {format(
                    new Date(cotizacionSeleccionada.fechaCreacion),
                ...
                <p>
                  ...
                  <EstadoBadge estado={cotizacionSeleccionada.estado} />
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-4">
            ...
            <div className="mt-2 p-3  rounded-md">
              <p className="whitespace-pre-wrap">
                {cotizacionSeleccionada.mensaje}
              </p>
            </div>
          </div>
          ...
          <form onSubmit={handleActualizarCotizacion} className="space-y-4">
            ...
            <DialogFooter>
              ...
              <Button
                ...
                onClick={() =>
                  cotizacionSeleccionada &&
                  iniciarRegistroCliente(cotizacionSeleccionada)
                }
              >
    ...
    <div className="space-y-4">
      ...
      >
                            ...
                            <div className="flex justify-end gap-2">
                              ...
                              {(cotizacion.estado === "aprobada" ||
                                ...
                                <Button
                                  ...
                                  className="text-orange-600 hover:text-orange-700"
                                  onClick={() =>
                                    iniciarRegistroCliente(cotizacion)
                                  }
                                >
                                  <UserPlus className="h-4 w-4" />
                              ...
                              <Button
                                ...
                                onClick={() =>
                                  confirmarEliminarCotizacion(cotizacion._id)
                                }
                              >
        ...
        <TabsContent value="registro" className="mt-6">
              ...
              <Card className="mb-4">
                <CardHeader className="pb-2">
                  <div className="flex items-center justify-between">
                    <div>
                      <CardTitle className="text-xl font-bold">
                        Registro desde Cotización Aprobada
                      </CardTitle>
                      <CardDescription>
                        Creando un nuevo cliente basado en la cotización #
                        {cotizacionSeleccionada._id}
                      </CardDescription>
                    </div>
                    <Button
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h3 className="font-medium text-orange-800">
                          Detalles de la cotización aprobada
                        </h3>
              ...
              <CardContent>
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-500 mb-4 max-w-md mx-auto">
                    ...
                    cotización aprobada para completar el registro
                    automáticamente.
                  </p>
          ...
          {mostrarRegistroCliente && !cotizacionSeleccionada && (
            <RegistroClientes />
          )}
        </TabsContent>
      </Tabs>
      ...
      <Dialog
        ...
        onOpenChange={setMostrarRegistroCliente}
      >
        <DialogContent className="max-w-5xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>Registrar Nuevo Cliente</DialogTitle>
            <DialogDescription>
              Complete los datos para registrar un nuevo cliente desde esta
              cotización
            </DialogDescription>
          </DialogHeader>
          ...
          {cotizacionSeleccionada && (
            <RegistroClientes
              cotizacionInicial={{
                ...
                montoMensual: cotizacionSeleccionada.total || 0,
                planSugerido:
                  cotizacionSeleccionada.servicio === "cotizacion_completa"
                    ? "premium"
                    : "basico",
              }}
              onComplete={() => {
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="py-4">
            <p className="text-sm text-gray-500">
              Al eliminar esta cotización, se perderán todos los datos
              asociados, incluyendo los comentarios y el historial de cambios.
            </p>
          </div>
