...
export function EstadoServicio({
  ...
  const historialCambios = [
    {
      ...
      hora: "14:32",
      estado: "activo",
      motivo: "Reactivación por usuario",
    },
    {
      fecha: "12/11/2023",
      hora: "09:15",
      estado: "desactivado",
      motivo: "Desactivación por usuario",
    },
    {
      fecha: "10/11/2023",
      hora: "18:45",
    ...
    },
    {
      ...
      hora: "10:20",
      estado: "desactivado",
      motivo: "Desactivación programada para mantenimiento",
    },
    {
      fecha: "01/11/2023",
      hora: "00:00",
      estado: "activo",
      motivo: "Inicio de servicio",
    },
  ];
  ...
  const ejecutarCambioEstado = () => {
    if (accionPendiente && onCambioEstado) {
      const nuevoEstado =
        accionPendiente === "activar" ? "activo" : "desactivado";
      ...
      {estadoActual === "suspendido" && (
        <div className="mt-2 flex items-center gap-2 text-red-600 dark:text-red-500">
          ...
          <span className="text-sm">
            El servicio ha sido suspendido. Por favor, contacte a soporte para
            reactivarlo.
          </span>
        </div>
      )}
      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="mt-4">
            ...
            <div className="text-sm">
              <span className="font-semibold">
                {historialCambios[0].fecha} {historialCambios[0].hora}
              </span>{" "}
              - {historialCambios[0].motivo}
            </div>
          </div>
          ...
          <AlertDialog
            ...
            onOpenChange={setInformacionAbierta}
          >
            <AlertDialogContent>
              <AlertDialogHeader>
                <AlertDialogTitle>Información del Servicio</AlertDialogTitle>
                <AlertDialogDescription>
                  <p className="mb-2">
                    Su servicio eléctrico actualmente está{" "}
                    <span className="font-semibold">
                  ...
                  <p>
                    Puede activar o desactivar su servicio en cualquier momento.
                    Tenga en cuenta que la activación puede tomar hasta 5
                    minutos en completarse.
                  </p>
                  <p className="mt-2">
                    Si su servicio ha sido suspendido, deberá contactar con
                    soporte para resolver la situación.
                  </p>
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
      ...
      >
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction onClick={ejecutarCambioEstado}>
              Confirmar{" "}
              {accionPendiente === "activar" ? "Activación" : "Desactivación"}
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
