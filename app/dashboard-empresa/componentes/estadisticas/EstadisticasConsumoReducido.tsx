    ...
    return (
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          {[...Array(2)].map((_, i) => (
            <div key={i} className="animate-pulse bg-gray-100 dark:bg-gray-800 p-2 rounded">
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-orange-50 dark:bg-orange-900/20 p-3 rounded-lg">
        <div className="text-sm text-gray-500 dark:text-gray-400">Consumo Mensual</div>
        <div className="text-2xl font-bold text-orange-600">
          {resumen.consumoMensual.toLocaleString("es-CL")} kWh
        </div>
        <div
        ...
        >
          ...
          {resumen.variacionMensual >= 0 ? "+" : ""}
          {resumen.variacionMensual.toFixed(1)}% vs. mes anterior
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="bg-amber-50 dark:bg-amber-900/20 p-2 rounded">
          <div className="text-xs text-gray-500 dark:text-gray-400 mb-1">Pico de consumo</div>
          <div className="font-semibold text-amber-600">
            {resumen.pico.valor} kWh
          </div>
        </div>

        <div className="bg-blue-50 dark:bg-blue-900/20 p-2 rounded">
          <div className="text-xs text-gray-500 dark:text-gray-400 mb-1">Eficiencia</div>
