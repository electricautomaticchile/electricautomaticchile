  ...
  const services = [
    {
      ...
      description:
        "Sistema inteligente para reposición automática del servicio eléctrico tras la regularización del pago.",
      benefits: [
    ...
    },
    {
      ...
      description:
        "Monitoreo en tiempo real del consumo energético para optimizar gastos y detectar anomalías.",
      benefits: [
    ...
    {
      id: "hardware",
      title: "Dispositivo IoT Inteligente",
      icon: <WrenchIcon className="h-5 w-5 text-orange-500" />,
      description:
        "Hardware de última generación para la gestión inteligente del suministro eléctrico.",
      benefits: [
        "Fácil instalación",
        "GPS integrado",
    ...
    },
    {
      ...
      icon: <GaugeIcon className="h-5 w-5 text-orange-500" />,
      description:
        "Sistema avanzado de predicción de demanda energética basado en IA y datos meteorológicos.",
      benefits: [
    ...
    },
    {
      ...
      icon: <WrenchIcon className="h-5 w-5 text-orange-500" />,
      description:
        "Análisis de correlaciones entre calidad del aire y patrones de consumo eléctrico.",
    ...
    <div className="w-full px-4 py-8 md:py-12">
      ...
      <div className="max-w-3xl mx-auto text-center mb-10">
        ...
        <p className="text-muted-foreground text-sm sm:text-base max-w-2xl mx-auto">
          Tecnología avanzada con IA, análisis predictivo y correlaciones
          ambientales para optimizar su red eléctrica y generar nuevas fuentes
          de valor.
        </p>
      </div>
            ...
            <div className="flex flex-col gap-2 sticky top-24">
              {services.map((service) => (
                ...
                >
                  ...
                  <ArrowRight
                    className={`h-4 w-4 transition-all duration-300 ${activeTab === service.id ? "text-orange-500 translate-x-1" : "opacity-0"}`}
                  />
                </button>
              ))}
            </div>
